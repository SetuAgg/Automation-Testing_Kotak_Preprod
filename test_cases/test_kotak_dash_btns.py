...
class Test_02_Kotak_Dash_Btns:
    ...
    def test_buttons(self,setup):
        ...
        time.sleep(2)
        my_schedule = self.driver.find_element(By.XPATH,"//a[text()='My Schedule']")
        self.driver.execute_script("arguments[0].style.border='5px solid red'", my_schedule)
        time.sleep(2)
        profile_tab = self.driver.find_element(By.XPATH,'//ul[@class="navbar-nav profile_thumbImg realtor_manager_login"]')
        self.driver.execute_script("arguments[0].style.border='5px solid red'", profile_tab)
        time.sleep(2)
        ...
        feedback_tab_high = self.driver.find_element(By.XPATH,'//div[@class="feedback--button contentDesktopView"]')
        self.driver.execute_script("arguments[0].style.border='5px solid red'", feedback_tab_high)
        time.sleep(2)
        ...
        time.sleep(2)
        take_a_tour_high = self.driver.find_element(By.XPATH,'//div[@class="take-tour-button"]')
        self.driver.execute_script("arguments[0].style.border='5px solid red'", take_a_tour_high)
        time.sleep(2)
